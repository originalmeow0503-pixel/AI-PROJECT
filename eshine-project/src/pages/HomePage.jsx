    ...
    <>
      ...
      <section className="container section-padding">
        <div className="grid-3">
          {[1, 2, 3].map((num) => (
            <div className="product-card" key={`model${num}`}>
              <Link to="/product" style={{ textDecoration: 'none', color: 'inherit' }}>
                <div className="product-img-wrapper">
                    <img src={`/landing-page/srcimgs/model${num}.png`} alt="Item" />
                </div>
                <div className="product-info">
                    <h3>Signature Wrap</h3>
                    <p className="price">Rs. 4,599</p>
                </div>
              </Link>
            </div>
          ))}
      ...
      <section className="container mb-16">
        <div className="grid-4">
          {[
            { img: 'grid4img1.webp', name: 'Summer Dress', price: 'Rs. 3,499' },
            { img: 'grid4img2.jpg', name: 'Classic Fit', price: 'Rs. 2,899' },
            { img: 'grid4img3.jpg', name: 'Monochrome Set', price: 'Rs. 5,200' },
            { img: 'grid4img4.webp', name: 'Premium Coat', price: 'Rs. 8,100' },
          ].map((item, idx) => (
            <div className="product-card" key={idx}>
              <Link to="/product" style={{ textDecoration: 'none', color: 'inherit' }}>
                <div className="product-img-wrapper">
                    <img src={`/landing-page/srcimgs/${item.img}`} alt={item.name} />
                </div>
                <div className="product-info">
                    <h3>{item.name}</h3>
